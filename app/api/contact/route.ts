...
export async function POST(req: Request) {
    try {
        ...
        await transporter.sendMail({
            ...
            subject: `Contact Form – ${name} | ${interested_property} | ${phone}`,
            html: `
      ...
      `,
        ...
        await transporter.sendMail({
            ...
            to: email,
            subject: `Thank You for Contacting G R Premium Properties`,
            html: `
<table width="100%" bgcolor="#f4f4f4" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" style="padding:40px 0;">
      ...
      <table width="600" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
        ...
        <tr>
          <td style="padding:35px;font-family:Arial;color:#333;">
            ...
            <p>
              Our property advisor will contact you shortly with complete
              pricing, availability, and investment details.
            </p>
