...
export default function DeveloperAboutClient({
  ...
  return (
    <section className="py-20 bg-white dark:bg-[#0F172A] transition-colors duration-300 font-body">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* DESCRIPTION */}
        <p className="font-body text-gray-700 dark:text-gray-300 leading-relaxed max-w-4xl text-base md:text-lg">
